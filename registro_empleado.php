...
<body>
    ...
    <header class="header col-3">
        ...
        <div class="col-6 m-auto">
            <h1 class="text-center m-5">Registro de Personal</h1>
            <?php
            ...
            <div class="mb-3 col-12">
                ...
                <div class="mb-3 col-4">
                    ...
                    <input type="tetx" class="form-control" name="apellidoP">
                </div>
                <div class="mb-3 col-4">
                    <label class="form-label">Apellido Materno</label>
                    <input type="tetx" class="form-control" name="apellidoM">
                </div>
                <div class="mb-3 col-4">
                    <label class="form-label">Numero de Empleado</label>
                    <input type="tetx" class="form-control" name="numEmpleado">
                </div>
